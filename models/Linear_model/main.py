...
def emory():
    ...
    ## Create database
    train_data_emory = CustomedDataset(X_train_emory,Y_train_emory,X_train_target_emory,Y_train_target_emory)
    test_data_emory = CustomedDataset(X_test_emory,Y_test_emory,X_test_target_emory,Y_test_target_emory)
    val_data_emory = CustomedDataset(X_val_emory,Y_val_emory,X_val_target_emory,Y_val_target_emory)

    print("Creating dataloaders")
    ## Create dataloader
    batch_size = 10 ## cannot increase batch size for now... needs some kind of padding... I think...
